...
const MobileNav: React.FC<MobileNavProps> = ({ activeTab, onTabChange, notificationsUnreadCount = 0 }) => {
  return (
      ...
      <div className="flex-1 flex items-center justify-center gap-10 px-2">
        ...
        >
          ...
          {notificationsUnreadCount > 0 && (
            <span className="absolute top-1 right-1 rounded-full bg-blue-500 text-white text-[9px] font-bold leading-none min-w-[16px] h-4 px-1 flex items-center justify-center">
